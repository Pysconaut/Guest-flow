...
export function PricingCard({
  ...
  return (
    ...
    >
      <Card className="relative mx-auto w-full max-w-4xl overflow-hidden border-2 border-primary/50 shadow-2xl shadow-primary/20">
        <div className="flex flex-col lg:flex-row">
          ...
          <motion.div
            className="bg-muted/20 p-6 lg:w-3/5 lg:p-10"
            variants={itemVariants}
          >
